...
const corsOptions = {
  origin: ["https://mrprayag077.github.io","https://mrprayag077.github.io/Gram-Panchayat", "https://mrprayag077.github.io/Gram-Panchayat/index.html"],
  methods: ["GET", "POST"],
  credentials: true,
};
...
app.post("/formsubmit", (req, res) => {
  ...
  const uniqueFilename = `pmodified.pdf`;
  ...
  async function processRequestQueue() {
    ...
    const uniqueFilename = request.uniqueFilename;
    const res = request.res;
  
    const demoText1 = formData.demoText1;
    const demoText2 = formData.demoText2;
    console.log('knidniniennenoendnononeononeond--------------------');
    console.log(demoText1);
